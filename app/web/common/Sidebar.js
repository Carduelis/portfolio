...
class Sidebar extends Component {
  ...
  touchSidebarWidth() {
    ...
    const { touchCurrentX, touchStartX, sidebarWidth } = this.state;
    const touchDeltaX = touchStartX - touchCurrentX;
    if (this.props.pullRight) {
      if (this.props.open && window.innerWidth - touchStartX < sidebarWidth) {
        if (touchCurrentX > touchStartX) {
          return sidebarWidth + touchDeltaX;
        }
        return sidebarWidth;
      }
    ...
    if (this.props.open && touchStartX < sidebarWidth) {
      if (touchCurrentX > touchStartX) {
        return sidebarWidth;
      }
      return sidebarWidth - touchDeltaX;
